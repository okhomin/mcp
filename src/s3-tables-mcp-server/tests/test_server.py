...
"""Tests for the awslabs.documentdb-mcp-server MCP Server."""

import pytest
from awslabs.awslabs.documentdb_mcp_server_mcp_server.server import example_tool
from awslabs.awslabs.documentdb_mcp_server_mcp_server.server import math_tool

@pytest.mark.asyncio
async def test_example_tool():
    # Arrange
    test_query = "test query"
    expected_project_name = "awslabs awslabs.documentdb-mcp-server MCP Server"
